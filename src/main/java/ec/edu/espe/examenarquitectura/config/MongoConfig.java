package ec.edu.espe.examenarquitectura.config;
...
public class MongoConfig extends AbstractMongoClientConfiguration {
    ...
    public MongoClient mongoClient() {
        //return MongoClients.create("mongodb+srv://mecalvopina:123@cluster.osspq.mongodb.net/examen?retryWrites=true&w=majority");
        return MongoClients.create("mongodb://localhost/examen");
    }
